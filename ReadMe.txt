...
--All these filese are also availabe
 ...
 3.the number of transactions for each model per zip code per state.
 4.the cheapest cellphone
 5.the average price for each model in the top5 manufacturers in terms of sales quantity and order by average price.
 6.the names of the customers and the average amount spent in 2009,where the average is higher than 500
 7.if there is any model that was in the top 5 in terms of quantity,simultaneously in 2008, 2009 and 2010
